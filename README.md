...
- **Omni chat and speech**: [Qwen3-Omni](https://sgl-project.github.io/sglang-omni/cookbook/qwen3_omni.html), [Ming-Omni](https://sgl-project.github.io/sglang-omni/cookbook/ming_omni.html); [MOSS-Speech](./docs/cookbook/moss_speech.md) (offline and opt-in streaming, measured A800 profile) — multimodal in, text/audio out.
